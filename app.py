...
class CronBuddyApp(ctk.CTk):
    """The main application window for CronBuddy."""
    ...
    def refresh_jobs(self) -> None:
        """Refreshes the job list in the main view."""
    ...
    def _create_job_card(self, job: dict[str, Any]) -> None:
        """Creates a visual card for a cron job.
    ...
    def add_job(self) -> None:
        """Opens the dialog to add a new cron job."""
    ...
    def edit_job(self, job: dict[str, Any]) -> None:
        """Opens the dialog to edit an existing cron job.
    ...
    def delete_job(self, comment: str) -> None:
        """Deletes a cron job after confirmation.
    ...
    def toggle_job(self, job: dict[str, Any]) -> None:
        """Toggles a cron job between enabled and disabled.
    ...
    def _build_file_manager_tab(
        ...
        """Builds a tab for the file manager.

        Args:
            window: The file manager window.
            parent_tab: The tab frame.
            manager: The ScriptManager for this tab's files.
        """
        ...
        def refresh_scripts() -> None:
            ...
            for s in scripts:
                ...
                lbl = ctk.CTkLabel(f, text=s['name'], font=ctk.CTkFont(weight="bold"))
